...
window.HY_DATA = {
  ...
  funMethods: [
    {
      ...
      desc:"通过有趣的图画，让孩子看到汉字就像看到一幅画。",
      items:[
        {img:"🐦",word:"鸟",pinyin:"niǎo",hint:"小鸟展翅飞"},
        {img:"☀️",word:"日",pinyin:"rì",hint:"太阳一个圆"},
        {img:"🌙",word:"月",pinyin:"yuè",hint:"弯弯的月牙"},
        {img:"⛰️",word:"山",pinyin:"shān",hint:"三座山连起来"},
        {img:"💧",word:"水",pinyin:"shuǐ",hint:"水滴三条线"},
        {img:"🔥",word:"火",pinyin:"huǒ",hint:"火苗往上窜"},
        {img:"🌳",word:"木",pinyin:"mù",hint:"一棵树"},
        {img:"🐟",word:"鱼",pinyin:"yú",hint:"鱼儿游水中"}
      ]
    },
    {
      id:"ani",
      ic:"🎬",t:"动画识字",d:"演字起源故事",
      desc:"把每个汉字变成一段动画小故事，看完记住一辈子！",
      items:[
        {word:"休",pinyin:"xiū",story:"一个人靠着一棵树 = 休息",img:"🧍🌳"},
        {word:"明",pinyin:"míng",story:"日 + 月 = 明亮",img:"☀️+🌙"},
        {word:"森",pinyin:"sēn",story:"三棵树 = 森林",img:"🌳🌳🌳"},
        {word:"林",pinyin:"lín",story:"两棵树 = 林",img:"🌳🌳"},
        {word:"休",pinyin:"xiū",story:"人 + 木 = 休(息)",img:"🧍+🌳"},
        {word:"从",pinyin:"cóng",story:"两个人 = 从",img:"🚶🚶"},
        {word:"众",pinyin:"zhòng",story:"三个人 = 众人",img:"🧍🧍🧍"},
        {word:"晶",pinyin:"jīng",story:"三日 = 晶莹",img:"☀️☀️☀️"},
        {word:"看",pinyin:"kàn",story:"手 + 目 = 看",img:"✋+👁️"},
        {word:"好",pinyin:"hǎo",story:"女 + 子 = 好",img:"👧+👦"},
        {word:"灭",pinyin:"miè",story:"把火盖住 = 灭",img:"🔥➡️"},
        {word:"泪",pinyin:"lèi",story:"水 + 目 = 泪",img:"💧+👁️"}
      ]
    },
    {
      id:"picto",
      ic:"象",t:"象形字",d:"'日'像太阳，'山'像山",
      desc:"中国最早的文字，画出形状就是字。",
      items:[
        {word:"日",old:"⊕",new:"日",pinyin:"rì",ex:"日出",img:"☀️"},
        {word:"月",old:"☾",new:"月",pinyin:"yuè",ex:"月圆",img:"🌙"},
        {word:"山",old:"ᴧᴧᴧ",new:"山",pinyin:"shān",ex:"高山",img:"⛰️"},
        {word:"水",old:"≈≈",new:"水",pinyin:"shuǐ",ex:"水流",img:"💧"},
        {word:"木",old:"⊥",new:"木",pinyin:"mù",ex:"树木",img:"🌳"},
        {word:"羊",old:"𦍌",new:"羊",pinyin:"yáng",ex:"小羊",img:"🐑"}
      ]
    },
    {
      id:"radical",
      ...
      radicals:[
        {
          r:"氵",name:"三点水",ex:"和水有关",
          examples:[
            {w:"江",pinyin:"jiāng",m:"江水"},
            {w:"河",pinyin:"hé",m:"小河"},
            {w:"湖",pinyin:"hú",m:"湖水"},
            {w:"海",pinyin:"hǎi",m:"大海"}
          ]
        ...
        {
          r:"木",name:"木字旁",ex:"和树木植物有关",
          examples:[
            {w:"林",pinyin:"lín",m:"树林"},
            {w:"树",pinyin:"shù",m:"大树"},
            {w:"桃",pinyin:"táo",m:"桃子"},
            {w:"桥",pinyin:"qiáo",m:"小桥"}
          ]
        },
        {
          r:"讠",name:"言字旁",ex:"和说话有关",
          examples:[
            {w:"说",pinyin:"shuō",m:"说话"},
            {w:"话",pinyin:"huà",m:"讲话"},
            {w:"读",pinyin:"dú",m:"读书"},
            {w:"认",pinyin:"rèn",m:"认字"}
          ]
        ...
        {
          r:"口",name:"口字旁",ex:"和嘴巴有关",
          examples:[
            {w:"吃",pinyin:"chī",m:"吃饭"},
            {w:"唱",pinyin:"chàng",m:"唱歌"},
            {w:"叫",pinyin:"jiào",m:"大叫"},
            {w:"吗",pinyin:"ma",m:"是/对吗"}
          ]
        },
        {
          r:"忄",name:"竖心旁",ex:"和心情有关",
          examples:[
            {w:"想",pinyin:"xiǎng",m:"想念"},
            {w:"怕",pinyin:"pà",m:"害怕"},
            {w:"快",pinyin:"kuài",m:"快乐"},
            {w:"情",pinyin:"qíng",m:"心情"}
          ]
        },
        {
          r:"扌",name:"提手旁",ex:"和手有关",
          examples:[
            {w:"打",pinyin:"dǎ",m:"打球"},
            {w:"拍",pinyin:"pāi",m:"拍手"},
            {w:"抱",pinyin:"bào",m:"拥抱"},
    ...
    },
    {
      ...
      desc:"猜字谜，记一辈子！动动小脑筋。",
      items:[
        {riddle:"一口咬掉牛尾巴，是什么字？",answer:"告"},
        {riddle:"一口咬掉牛尾巴，再吞一口，是什么字？",answer:"告（再演）"},
        {riddle:"上下一体，是什么字？",answer:"卡"},
        {riddle:"一个口，两个口，三个口，是什么字？",answer:"品"},
        {riddle:"半个月，是什么字？",answer:"月"},
        {riddle:"半青半紫，是什么字？",answer:"素"},
        {riddle:"画时圆，写时方，冬时短，夏时长，是什么字？",answer:"日"},
        {riddle:"十个加十个，还是十个，是什么字？",answer:"千(十个十 = 千)"}
      ]
    },
    {
      id:"contrast",
      ...
      desc:"找一找，哪里不一样，记得更牢！",
      pairs:[
        {a:"明",b:"暗",ta:"反义",exa:"明亮",exb:"黑暗"},
        {a:"上",b:"下",ta:"反义",exa:"上楼",exb:"下楼"},
        {a:"大",b:"小",ta:"反义",exa:"大象",exb:"小蚂蚁"},
        {a:"多",b:"少",ta:"反义",exa:"很多",exb:"很少"},
        {a:"高",b:"低",ta:"反义",exa:"高山",exb:"低地"},
        {a:"天",b:"地",ta:"反义",exa:"天空",exb:"大地"},
        {a:"未",b:"末",ta:"形近",exa:"未来",exb:"末尾"},
        {a:"己",b:"已",ta:"形近",exa:"自己",exb:"已经"},
        {a:"千",b:"干",ta:"形近",exa:"千万",exb:"干净"},
        {a:"人",b:"入",ta:"形近",exa:"大人",exb:"入门"}
      ]
    },
    {
      id:"rhythm",
      ...
      songs:[
        {
          t:"《日月明》",
          lines:["日月明，" ,"鱼羊鲜，" ,"小大尖，" ,"一人不成众。"],
          words:["明","鲜","尖","众"]
        },
        {
          t:"《人之初》",
          lines:["人之初，性本善。","性相近，习相远。"],
          words:["人","性","习","远"]
        },
        {
          t:"《春夏秋冬》",
          lines:["春暖花开夏雨多，","秋叶飘落冬雪白。"],
          words:["春","夏","秋","冬"]
        },
        {
          t:"《拍手歌》",
          lines:["你拍一，我拍一，","一个小孩会穿衣。","你拍二，我拍二，","两个小孩会刷牙。"],
          words:["拍","穿","刷"]
        },
        {
          t:"《上学歌》",
    ...
    },
    {
      ...
      desc:"玩玩游戏，识字一点都不难！",
      games:[
        {n:"拼音接龙",d:"前一个字拼音的尾音 = 后一个字拼音的首音",ex:"马 (ma) → 啊 (a) → 花 (hua) →"},
        {n:"找字朋友",d:"找出有相同部首的字",ex:"从「江、河、海、湖」中找一找，它们的部首都是？　氵"},
        {n:"组词大挑战",d:"用一个字组出三个词",ex:"用「花」组词：花朵、花儿、花园"},
        {n:"反义词配对",d:"把意思相反的字配一对",ex:"上 —— 下，明 —— 暗，多 —— 少"}
      ]
    }
  ],
  ...
  readingList: [
    // ========== 短句 (12 篇) ==========
    {title:"小白兔",level:"短句",icon:"🐰",passage:"小白兔，长耳朵，爱吃萝卜爱吃菜。蹦蹦跳跳真可爱。",q:"小白兔爱吃什么？",a:"萝卜和菜。"},
    {title:"小鸡",level:"短句",icon:"🐥",passage:"小小鸡，叽叽叽，跟在妈妈身后走。找到小虫一条条，吃得真开心。",q:"小鸡爱吃什么？",a:"小虫。"},
    {title:"太阳",level:"短句",icon:"☀️",passage:"太阳出来一条线，慢慢升到天顶上。白云朵朵散开去，照得大地亮堂堂。",q:"太阳升到哪儿了？",a:"天顶上。"},
    {title:"雨点",level:"短句",icon:"🌧️",passage:"雨点滴滴嗒嗒响，落在花儿上。落在树叶上，落在我的小伞上。",q:"雨点落在哪儿？",a:"花儿、树叶、小伞。"},
    {title:"大树",level:"短句",icon:"🌳",passage:"大树叶儿多，小鸟来做窝。风吹树叶动，小鸟唱起歌。",q:"谁在树上做窝？",a:"小鸟。"},
    {title:"小猫",level:"短句",icon:"🐱",passage:"小猫走路没声音，捉老鼠是本领。胡子一翘胡子一翘，瞪着大眼睛。",q:"小猫有什么本领？",a:"捉老鼠。"},
    {title:"小鱼",level:"短句",icon:"🐟",passage:"小鱼水里游，摇摇尾巴点点头。吐出小泡泡，咕噜咕噜真有趣。",q:"小鱼吐什么？",a:"小泡泡。"},
    {title:"月亮",level:"短句",icon:"🌙",passage:"弯弯的月亮像小船，挂在蓝蓝的天上。小星星眨眼睛，月亮对我笑一笑。",q:"月亮像什么？",a:"小船。"},
    {title:"彩虹",level:"短句",icon:"🌈",passage:"雨停了，太阳出来啦。天上挂着一道桥，红橙黄绿青蓝紫，七种颜色真漂亮。",q:"彩虹有几种颜色？",a:"七种。"},
    {title:"小雪花",level:"短句",icon:"❄️",passage:"小雪花，飘呀飘，落在屋顶上，落在小树梢。小朋友伸出手，雪花对他微微笑。",q:"雪花落在哪儿？",a:"屋顶、树梢、小朋友手上。"},
    {title:"小蜜蜂",level:"短句",icon:"🐝",passage:"小蜜蜂，嗡嗡嗡，飞到东飞到西。采了花蜜做蜂蜜，甜甜的真好吃。",q:"蜜蜂采什么？",a:"花蜜。"},
    {title:"我的家",level:"短句",icon:"🏡",passage:"我家有爸爸，有妈妈，还有爷爷奶奶。一家人相亲相爱，我的家真温暖。",q:"家里有谁？",a:"爸爸、妈妈、爷爷奶奶。"},

    // ========== 儿歌 (8 篇) ==========
    {title:"小鸟学飞",level:"儿歌",icon:"🐦",passage:"小麻雀，叫喳喳，跟着妈妈学飞翔。扑扑翅膀飞起来，小小鸟儿本领大。",q:"小麻雀跟谁学飞？",a:"妈妈。"},
    {title:"种太阳",level:"儿歌",icon:"🌻",passage:"我有一个心愿，种一颗太阳。春天到，花儿开，冬天到，不再寒冷。",q:"小朋友的心愿是什么？",a:"种一颗太阳。"},
    {title:"小蜡笔",level:"儿歌",icon:"🖍️",passage:"我有彩色的小蜡笔，红的画苹果，黄的画鸭子。蓝的画小河，绿的画草地。",q:"红的蜡笔画什么？",a:"苹果。"},
    {title:"刷牙歌",level:"儿歌",icon:"🦷",passage:"小小牙刷手中拿，上下里外都刷刷。早晚刷牙口香香，牙齿白白真漂亮。",q:"什么时候要刷牙？",a:"早上和晚上。"},
    {title:"国旗",level:"儿歌",icon:"🇨🇳",passage:"国旗国旗真美丽，五颗金星照大地。我向国旗敬个礼，祖国在我心里。",q:"国旗上有几颗星？",a:"五颗。"},
    {title:"上学",level:"儿歌",icon:"🎒",passage:"背着小书包，高高兴兴上学去。见到老师说您好，见到同学笑一笑。",q:"见到老师要说什么？",a:"您好。"},
    {title:"洗手歌",level:"儿歌",icon:"🧼",passage:"卷起袖口洗洗手，自来水冲一冲。搓搓手心搓手背，洗掉细菌真干净。",q:"洗手要搓哪儿？",a:"手心和手背。"},
    {title:"穿衣歌",level:"儿歌",icon:"👕",passage:"小衣服，自己穿。抓住领口翻一翻，抓住袖口伸一伸。再把扣子扣好，漂亮衣服穿身上。",q:"扣子在哪儿？",a:"衣服前面。"},

    // ========== 小故事 (8 篇) ==========
    {title:"小熊请客",level:"小故事",icon:"🐻",passage:"小熊过生日，请朋友们来家玩。小兔来了，送萝卜。小羊来了，送青草。小猫来了，送鱼。大家一起唱歌跳舞，真开心！",q:"谁送了萝卜？",a:"小兔。"},
    {title:"乌鸦喝水",level:"小故事",icon:"🐦",passage:"一只乌鸦口渴了。它看见一个瓶子，瓶子里水很少。它把小石子一颗一颗放进去，水慢慢升高了，乌鸦喝到了水。",q:"乌鸦用了什么办法？",a:"往瓶子里放石子。"},
    {title:"小熊学礼貌",level:"小故事",icon:"🐻",passage:"小熊去小白兔家做客。它不敲门就进去，踩了小白兔的花。小熊脸红了，说：'对不起！'以后小熊每次都先敲门。",q:"小熊一开始做了什么不对的事？",a:"不敲门就进去。"},
    {title:"小猪噜噜",level:"小故事",icon:"🐷",passage:"小猪噜噜不爱洗澡，朋友们都离它远远的。一天它身上爬满跳蚤，痒得直叫。妈妈帮它洗个澡，噜噜舒服地笑了。从此它爱洗澡了。",q:"噜噜后来变得怎样？",a:"爱洗澡。"},
    {title:"小兔种萝卜",level:"小故事",icon:"🐰",passage:"小兔子种了一颗萝卜种子。它每天浇水、施肥。种子发芽，长出叶子，最后结出大萝卜。小兔开心极了。",q:"小兔种出什么了？",a:"大萝卜。"},
    {title:"小猴子下山",level:"小故事",icon:"🐒",passage:"小猴子下山，掰了一个玉米。看见桃子扔玉米，看见西瓜扔桃子，看见兔子扔西瓜。回家什么也没有。",q:"小猴子最后有什么？",a:"什么也没有。"},
    {title:"要下雨了",level:"小故事",icon:"☁️",passage:"小白兔割草。它看见小燕子低飞，看见小鱼透气，看见蚂蚁搬家。妈妈说：'要下雨了！'小白兔赶紧跑回家。",q:"要下雨前，蚂蚁会做什么？",a:"搬家。"},
    {title:"小猫钓鱼",level:"小故事",icon:"🐱",passage:"小猫和妈妈去钓鱼。小猫一会儿捉蝴蝶，一会儿捉蜻蜓。妈妈钓到大鱼，小猫什么也没钓到。它专心钓鱼，最后也钓到大鱼。",q:"小猫后来钓到鱼了吗？",a:"钓到了。"},

    // ========== 短文 (6 篇) ==========
    {title:"小马过河",level:"短文",icon:"🐴",passage:"小马要把一袋麦子送到磨坊去。来到一条小河边，小马不知道河水是深是浅，问牛伯伯，牛伯伯说很浅。小松鼠说很深。妈妈告诉小马：'只有自己试了才知道。'小马小心地走过了河。",q:"河水到底深不浅？",a:"要自己试了才知道。"},
    {title:"司马光砸缸",level:"短文",icon:"🪨",passage:"古时候，一个小孩掉进大水缸。大家都慌了，只有司马光没慌。他举起一块大石头，向水缸砸去。水流出来了，小孩得救了。",q:"司马光用什么救了小孩？",a:"用石头砸缸。"},
    {title:"孔融让梨",level:"短文",icon:"🍐",passage:"孔融四岁就和哥哥们一起吃梨。他挑了一个最小的梨，留给自己。爸爸问他为什么，他说：'哥哥们比我大，应该吃大的。'",q:"孔融为什么挑小梨？",a:"把大的让给哥哥。"},
    {title:"雪孩子",level:"短文",icon:"☃️",passage:"兔妈妈堆了个雪孩子陪小白兔玩。屋里着火，雪孩子冲进火里，救出小白兔，自己化成了水。它飞上天空变成了一朵白云。",q:"雪孩子最后变成了什么？",a:"白云。"},
    {title:"曹冲称象",level:"短文",icon:"🐘",passage:"有人送曹操一只大象，大家想称它有多重。曹冲有办法：把大象赶上船，在船边刻记号。再装石头到同样的高度，石头的重量就是大象的重量。",q:"用什么代替称大象？",a:"石头。"},
    {title:"铁杵成针",level:"短文",icon:"🪡",passage:"大诗人李白小时候不爱读书。一天看见老婆婆在磨一根铁杵，李白问她为什么磨。她说：'要把它磨成针。'李白听了很感动，从此发奋读书。",q:"老婆婆要把铁杵磨成什么？",a:"针。"},

    // ========== 记叙文 (6 篇) ==========
    {title:"揠苗助长",level:"记叙文",icon:"🌾",passage:"古时候有个农夫，他嫌禾苗长得慢，就把每棵禾苗都拔高了一些。回到家里，他对家人说：'今天真累，我帮禾苗都长高了。'儿子听了，第二天跑到田里一看，禾苗都枯死了。",q:"禾苗为什么枯死了？",a:"因为农夫把它们都拔断了。"},
    {title:"守株待兔",level:"记叙文",icon:"🐰",passage:"宋国有个农夫在田里干活。一只兔子撞在树桩上死了。农夫高兴地捡起兔子。从此他天天守在树桩旁，再也没等到兔子，田里的禾苗都枯了。",q:"这个农夫最后怎样了？",a:"禾苗都枯了，什么也没得到。"},
    {title:"画蛇添足",level:"记叙文",icon:"🐍",passage:"楚国有人举行比赛，画一条蛇先画完的能喝酒。一个人画好了，端起酒杯说：'我还能给它添上脚！'他画完脚，另一个人已经喝完了酒。",q:"画蛇添足的人为什么没喝到酒？",a:"因为他太慢了。"},
    {title:"狐假虎威",level:"记叙文",icon:"🦊",passage:"老虎抓住了一只狐狸。狐狸说：'我是天帝派来的，你不能吃我！'老虎不信。狐狸说：'你跟我走一趟。'动物看见老虎都跑了。狐狸其实借老虎的威风吓人。",q:"这个故事告诉我们什么？",a:"不要被表面吓到。"},
    {title:"对牛弹琴",level:"记叙文",icon:"🐄",passage:"古时候有个音乐家，公明仪弹琴弹得非常好听。一天他看见一头牛在吃草，就给牛弹了一首高雅曲子。牛只顾吃草，根本不理他。",q:"牛为什么没反应？",a:"它听不懂高雅曲子。"},
    {title:"亡羊补牢",level:"记叙文",icon:"🐑",passage:"古时候有个人养了一群羊。一天早上他发现羊圈破了个洞，少了几只羊。邻居劝他修羊圈，他说：'羊已经丢了，修也没用。'第二天羊又少了几只。他赶紧修好了羊圈，羊再也没少。",q:"他后来怎样补救了？",a:"赶紧修好羊圈。"}
  ],
  ...
  g1Words: [
    ...
    // ===== 一年级追加必学 =====
    "after","again","ago","all","also","and","animal","answer","apple","arm","ask","baby","back","bad","bag","ball","banana","basket","beach","bean",
    "bedroom","bee","beef","behind","bell","below","beside","between","big","bike","bird","black","blanket","blue","boat","body","book","born","bowl","box",
    "bread","breakfast","bridge","brother","brown","brush","build","burn","bus","cake","call","candy","car","card","care","cat","catch","chair","chicken","child",
    "China","Chinese","chocolate","choose","city","class","clean","clock","close","cloud","coat","coffee","cold","color","come","computer","cook","cool","corn","correct",
    "count","country","cousin","cow","cross","cry","cup","dance","dark","daughter","day","desk","dirty","dish","do","doctor","dog","doll","dollar","door",
    "down","draw","drink","drive","drop","duck","ear","early","earn","earth","east","eat","egg","eight","eleven","empty","end","enjoy","enter","eraser",
    "evening","every","example","excellent","eye","face","fact","fall","family","fan","far","farm","father","favorite","feel","feet","few","fifteen","fight","find",
    "fine","finger","finish","fire","first","fish","five","fix","flag","flat","flower","fly","follow","food","foot","football","for","forest","forget","fork",
    "four","fourteen","fox","free","fresh","friend","frog","front","fruit","full","future","game","garden","geography","get","ghost","giant","gift","girl","give",
    "glass","glasses","gloves","go","goat","gold","goldfish","golf","good","goodbye","goose","grade","grandfather","grandmother","grape","grass","great","green","ground","group",
    "guess","guitar","gum","habit","hair","half","hall","hand","handsome","happen","happy","hard","hat","head","healthy","hear","heart","heavy","hello","help",
    "hen","here","hero","hey","hide","high","hill","history","hit","hobby","hockey","hold","hole","holiday","home","homework","honest","honey","hope","horse",
    "hospital","hot","hotel","hour","house","how","hundred","hungry","hurry","hurt","ice","icecream","idea","important","in","inside","interesting","into","island","it",
    "its","jacket","jam","January","job","join","joke","joy","juice","July","jump","June","just","key","kick","kid","kill","kind","king","kiss",
    "kitchen","kite","knee","knife","knock","know","lake","lamb","lamp","land","language","large","last","late","later","laugh","law","lazy","leaf","learn",
    "leave","left","leg","lemon","less","lesson","let","letter","lettuce","level","library","lie","life","light","like","line","lion","list","listen","little",
    "live","living","lobby","local","long","look","loose","lose","lost","loud","love","lovely","low","lucky","lunch","machine","mad","magic","main",
    "make","man","many","map","March","mark","market","marry","math","matter","may","maybe","me","mean","meat","medicine","meet","melon","memory","menu",
    "middle","milk","mind","mine","minute","mirror","miss","mistake","mix","model","mom","moment","money","monkey","month","mood","moon","more","morning","most",
    "mother","mountain","mouse","mouth","move","movie","Mr","Mrs","much","music","must","name","napkin","narrow","near","neat","neck","need","needle","neighbor",
    "nephew","never","new","news","newspaper","next","nice","niece","night","nine","no","noble","noise","none","noon","north","nose","not","note","notebook",
    "nothing","notice","November","now","number","nurse","nut","ocean","October","of","off","office","often","oil","old","on","once","one","onion","only",
    "open","or","orange","order","other","our","out","outside","oven","over","own","page","paint","pair","palace","pan","panda","paper","parent","park",
    "part","partner","party","pass","past","path","patient","pay","pea","peace","peach","pear","pen","pencil","people","pepper","perfect","person","pet","phone",
    "photo","piano","pick","picture","pie","piece","pig","pillow","pilot","pineapple","pink","pizza","place","plain","plan","plane","plant","plate","play","please",
    "plum","pocket","poem","poet","point","poison","police","polite","pond","pool","poor","popcorn","popular","port","post","pot","potato","pour","practice","present",
    "pretty","price","prince","princess","print","prize","problem","program","promise","proud","pull","pumpkin","puppy","purple","push","put","puzzle","queen","question",
    "quick","quiet","quilt","rabbit","race","radio","rail","rain","rainbow","rainy","raise","rang","rare","rat","rather","read","ready","real","really","reason",
    "receive","recipe","record","red","refrigerator","remember","repair","repeat","report","rest","rice","rich","ride","right","ring","rise","river","road","roast","robot",
    "rock","rocket","roll","roof","room","root","rope","rose","round","row","royal","rub","rubber","rude","rule","run","sad","safe","sail","salt",
    "same","sand","sandwich","sauce","save","say","school","science","sea","season","second","secret","section","see","seed","seem","sell","send","senior","sense",
    "sentence","September","seven","several","shade","shadow","shake","shall","shallow","shame","shape","share","shark","sharp","she","sheep","sheet","shelf","shell","shine",
    "ship","shirt","shoe","shoot","shop","shopping","shore","short","should","shoulder","shout","show","shower","shy","sick","side","sigh","sight","sign","silent",
    "silk","silly","silver","simple","sing","single","sink","sir","sister","sit","six","size","skate","ski","skill","skin","skip","skirt","sky","sleep",
    "slow","small","smart","smell","smile","smoke","smooth","snack","snake","snow","snowman","soap","soccer","social","sock","soft","soil","solid","some","someone",
    "something","sometimes","son","song","soon","sorry","sort","soul","sound","soup","sour","south","space","spare","speak","special","speed","spell","spend","spider",
    "spin","spirit","spoon","sport","spot","spread","spring","square","squirrel","stable","stack","stage","stair","stamp","stand","star","start","station","stay","steak",
    "steal","steam","steel","step","stick","still","stomach","stone","stop","store","storm","story","stove","straight","strange","strawberry","street","strong","student","study",
    "subject","subway","succeed","success","such","sudden","sugar","suggest","suit","summer","sun","sunny","sunrise","sunset","super","supper","sure","surf","surprise","sweet",
    "swim","swing","switch","sword","syrup","table","tail","take","tale","talent","talk","tall","tank","tap","tape","task","taste","taxi","tea","teach",
    "teacher","team","teen","telephone","telescope","television","tell","ten","tennis","tent","test","than","thank","that","the","their","them","then","there","these",
    "they","thick","thief","thin","thing","think","third","thirteen","thirty","this","those","though","thought","thousand","three","throat","through","throw","thumb","Thursday",
    "ticket","tie","tiger","tight","time","tin","tip","tire","tired","title","to","toast","today","toe","together","toilet","tomato","tomorrow","tonight","too",
    "tool","tooth","top","topic","total","touch","tour","tourist","toward","tower","town","toy","track","trade","traffic","train","travel","tray","tree","trick",
    "trip","trouble","truck","true","truly","trumpet","trust","truth","try","T-shirt","Tuesday","tunnel","turkey","turn","twelve","twenty","twice","twin","two","type",
    "ugly","umbrella","uncle","under","understand","unit","university","until","unusual","up","upon","upper","upset","us","use","useful","usual","vacation","valley",
    "valuable","value","van","various","vase","vegetable","very","veterinarian","video","view","village","violin","visit","voice","vomit","vote","vowel","voyage","waist","wait",
    "waiter","walk","wall","wallet","walnut","wander","want","war","warm","wash","washer","watch","water","wave","way","we","weak","wear","weather","website",
    "wedding","Wednesday","week","weekend","weep","weigh","weight","welcome","well","west","wet","whale","what","wheat","wheel","when","where","which","while","whisper",
    "white","who","whole","why","wide","wife","wild","will","win","wind","window","wine","wing","winter","wish","with","within","without","woman","wonder",
    "wonderful","wood","wool","word","work","world","worm","worry","worth","would","wow","wrap","wrist","write","writer","wrong","yard","year","yellow","yes",
    "yesterday","yet","you","young","your","youth","yummy","zero","zip","zone","zoo"
  ],
